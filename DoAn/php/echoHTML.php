...
function addFooter()
{
    ...
    <div class="copy-right">
        <p>
            Thế Giới Điện Tử chuyên cung cấp sản phẩm tốt và vất lượng
            <span style="color: #eee; font-weight: bold">BBH-group</span>
        </p>
    </div>';
}

// Thêm contain Taikhoan
//form đăng nhập đâng ký của khách hàng
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                ...
                <li>Trải Nghiệm Sản Phẩm Tài Nhà</li>
                <li>Lỗi Đổi Sản Phẩm Tại Nhà</li>
                <li>Hỗ trợ suốt thời gian trong vòng 3 tháng
                    <br>Hotline:
                    <a href="tel:0332987234" style="color: #288ad6;">0332987234</a>
                </li>
            </ul>
        </section>
    </div>';
